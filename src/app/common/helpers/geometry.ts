 ...
 * of "projection".
 */
export const getRectOccludedLineBetweenTwoPoints = (point1: Point2D, point2: Point2D, rect: Rect): [Point2D, Point2D] => {
 ...
 */
export const getRectOccludedLineBetweenTwoPointsUsingAxesBounds = (
  point1: Point2D,
  point2: Point2D,
